...
<head>
    ...
    <link rel="icon" href="{{ asset('dashboard_assets') }}/assets/images/dashboard/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('dashboard_assets') }}/assets/images/dashboard/favicon.png" type="image/x-icon">
    ...
    <!-- Font Awesome-->
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard_assets') }}/assets/css/vendors/font-awesome.css">
    ...
    <!-- Chartist css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard_assets') }}/assets/css/vendors/chartist.css">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard_assets') }}/dropify.css">
    <link rel="stylesheet" href="https://cdn.datatables.net/1.12.1/css/dataTables.bootstrap5.min.css">
    <link rel="stylesheet" href="{{ asset('dashboard_assets') }}/select2.min.css">
</head>
...
<body class="rtl">
    ...
    <!-- latest jquery-->
    <script src="{{ asset('dashboard_assets') }}/assets/js/jquery-3.3.1.min.js"></script>

    <!-- Bootstrap js-->
    <script src="{{ asset('dashboard_assets') }}/assets/js/bootstrap.bundle.min.js"></script>
    ...
    <!--chartist js-->
    <script src="{{ asset('dashboard_assets') }}/assets/js/chart/chartist/chartist.js"></script>

    <!--chartjs js-->
    <script src="{{ asset('dashboard_assets') }}/assets/js/chart/chartjs/chart.min.js"></script>

    <!-- lazyload js-->
    <script src="{{ asset('dashboard_assets') }}/assets/js/lazysizes.min.js"></script>
    ...
    <!--peity chart js-->
    <script src="{{ asset('dashboard_assets') }}/assets/js/chart/peity-chart/peity.jquery.js"></script>

    <!-- Apex Chart Js -->
    <script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>

    <!--sparkline chart js-->
    <script src="{{ asset('dashboard_assets') }}/assets/js/chart/sparkline/sparkline.js"></script>

    <!--Customizer admin-->
    {{-- <script src="{{ asset('dashboard_assets') }}/assets/js/admin-customizer.js"></script> --}}

    <!--dashboard custom js-->
    <script src="{{ asset('dashboard_assets') }}/assets/js/dashboard/default.js"></script>

    <!--right sidebar js-->
    <script src="{{ asset('dashboard_assets') }}/assets/js/chat-menu.js"></script>

    <!--height equal js-->
    <script src="{{ asset('dashboard_assets') }}/assets/js/height-equal.js"></script>

    <!-- lazyload js-->
    <script src="{{ asset('dashboard_assets') }}/assets/js/lazysizes.min.js"></script>

    <!--script admin-->
    <script src="{{ asset('dashboard_assets') }}/assets/js/admin-script.js"></script>
    <script src="{{ asset('dashboard_assets') }}/dropify.js"></script>
    <script src="https://cdn.datatables.net/1.12.1/js/jquery.dataTables.min.js"></script>
    <script src="https://cdn.datatables.net/1.12.1/js/dataTables.bootstrap5.min.js"></script>
    <script src="{{ asset('dashboard_assets') }}/select2.min.js"></script>
    <script>
        $('.dropify').dropify();
    </script>
