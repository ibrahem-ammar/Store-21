...
<head>
    ...
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="{{asset('dashboard_assets')}}/assets/css/vendors/themify-icons.css">
...
<body class="rtl">
    ...
    <script src="{{asset('dashboard_assets')}}/assets/js/slick.js"></script>
